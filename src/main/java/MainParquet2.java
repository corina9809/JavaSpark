...
public class MainParquet2 {

    private static String path ="C:\\Users\\Linda Kurmann\\Documents\\projekte\\JavaSpark\\src\\main\\data\\zipcodes.parquet";
    ...
    private static void readParquet(final File f) throws IOException
    {
